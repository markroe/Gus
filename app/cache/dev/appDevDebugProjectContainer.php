...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'rolab_ugs.form.type.job' => 'getRolabUgs_Form_Type_JobService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gus', 'user' => 'gus', 'password' => 'BUjLq6ADzxQ7Nwea', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/var/www/src/Roelab/GusBundle/Resources/config/doctrine' => 'Roelab\\GusBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Roelab\\GusBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('RoelabGusBundle' => 'Roelab\\GusBundle\\Entity'));
    ...
    /**
     * Gets the 'rolab_ugs.form.type.job' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Roelab\GusBundle\Form\Type\JobType A Roelab\GusBundle\Form\Type\JobType instance.
     */
    protected function getRolabUgs_Form_Type_JobService()
    {
        return $this->services['rolab_ugs.form.type.job'] = new \Roelab\GusBundle\Form\Type\JobType();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('sandbox49525.mailgun.org');
        $instance->setPort(25);
        $instance->setEncryption(NULL);
        $instance->setUsername('postmaster@sandbox49525.mailgun.org');
        $instance->setPassword('75unvtiybjj3');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('841887a179a1376e7b698030a4397bd7');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'gus',
            'database_user' => 'gus',
            'database_password' => 'BUjLq6ADzxQ7Nwea',
            'mailer_transport' => 'smtp',
            'mailer_auth_mode' => 'plain',
            'mailer_host' => 'sandbox49525.mailgun.org',
            'mailer_user' => 'postmaster@sandbox49525.mailgun.org',
            'mailer_password' => '75unvtiybjj3',
            'locale' => 'en',
            'secret' => '841887a179a1376e7b698030a4397bd7',
            'database_path' => NULL,
            ...
            'kernel.secret' => '841887a179a1376e7b698030a4397bd7',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'sandbox49525.mailgun.org',
            'swiftmailer.mailer.default.transport.smtp.username' => 'postmaster@sandbox49525.mailgun.org',
            'swiftmailer.mailer.default.transport.smtp.password' => '75unvtiybjj3',
